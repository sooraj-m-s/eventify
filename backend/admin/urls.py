...
from .views import (
    ...
    AdminDashboardView, AdminFiltersView, DownloadRevenueReportView
)
...
urlpatterns = [
    ...
    path('dashboard/download_report/', DownloadRevenueReportView.as_view(), name='download-revenue-report'),
