...
class EventListView(ListAPIView):
    ...
    def get_queryset(self):
        try:
            ...
            logger.error(f"Error in EventListView.get_queryset: {e}")
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            logger.error(f"Error in EventListView.list: {e}")
            return Response({'success': False, 'error': 'An error occurred while fetching events.'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class OrganizerSearchView(ListAPIView):
    ...
    def get_queryset(self):
        try:
            ...
            logger.error(f"Error in OrganizerSearchView.get_queryset: {e}")
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            logger.error(f"Error in OrganizerSearchView.list: {e}")
            return Response({'success': False, 'error': 'An error occurred while fetching organizers.'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class OrganizerDetailView(RetrieveAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            logger.error(f"OrganizerProfile not found for user_id: {kwargs.get('user_id')}")
